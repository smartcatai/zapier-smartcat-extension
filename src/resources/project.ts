...
const Project = {
    ...
    create:{
        ...
        operation: {
            inputFields: [
                ...
                {key: 'sourceLanguage', choices: SmartcatLanguages, required: true, type: 'string', label: 'Source Language'},
                {key: 'targetLanguages', choices: SmartcatLanguages, required: true, list: true, type: 'string', label: 'Target Languages'},
                {key: 'workflowStages', choices: SmartcatProjectStage, required: true, list: true, type: 'string', label: 'Workflow Stages'},
    ...
    get: {
        ...
        operation: {
            inputFields: [
                {key: "id", required:true, type:'string', label:"Id"},
            ],
            perform: getProject
        }
